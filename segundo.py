...
#funcion que realiza las converciones
...
#crea etiquetas y colocalass ne la cudricula
...
combo_origen.set(divisas[0]) #establecer el valor predetrminado 
combo_destino = tk.StringVar()
combo_destino.set(divisas[1])# establecer  el valor prederminado
